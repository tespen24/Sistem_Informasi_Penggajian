...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="perolehan_gaji_add.php" class="btn btn-primary">
                        ...
                        <?php $no = 1; foreach ($daftar_perolehan as $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="perolehan_gaji_edit.php?id=<?= $row['id_perolehan'] ?>" class="btn btn-sm btn-warning text-white" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a href="perolehan_gaji_del.php?id=<?= $row['id_perolehan'] ?>"

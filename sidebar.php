...
$menu_admin = [
    ...
    ['icon' => 'bi-people-fill',    'label' => 'Data Karyawan',    'link' => 'karyawan_read.php',  'key' => 'karyawan_read'],
    ['icon' => 'bi-briefcase-fill', 'label' => 'Jabatan',          'link' => 'jabatan_read.php',   'key' => 'jabatan_read'],
    ['icon' => 'bi-calendar-check', 'label' => 'Absensi',          'link' => 'absensi_read.php',   'key' => 'absensi_read'],
    ['icon' => 'bi-cash-stack',     'label' => 'Perolehan Gaji',   'link' => 'perolehan_gaji_read.php', 'key' => 'perolehan_gaji_read'],
    ['icon' => 'bi-dash-circle',    'label' => 'Potongan Gaji',    'link' => 'pemotongan_gaji_read.php', 'key' => 'pemotongan_gaji_read'],
    ['icon' => 'bi-wallet2',        'label' => 'Penggajian',       'link' => 'penggajian_read.php', 'key' => 'penggajian_read'],
    ['icon' => 'bi-file-earmark-bar-graph', 'label' => 'Laporan', 'link' => 'laporan.php',   'key' => 'laporan'],
];

$menu_karyawan = [
    ['icon' => 'bi-speedometer2',   'label' => 'Dashboard',       'link' => 'dashboard_karyawan.php', 'key' => 'dashboard_karyawan'],
    ['icon' => 'bi-wallet2',        'label' => 'Data Gaji',       'link' => 'penggajian_read.php',   'key' => 'penggajian_read'],
    ['icon' => 'bi-file-earmark-bar-graph', 'label' => 'Laporan', 'link' => 'laporan.php',      'key' => 'laporan'],
];

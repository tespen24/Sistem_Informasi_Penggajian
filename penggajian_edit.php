...
<div class="d-flex align-items-center mb-3">
    <a href="penggajian_read.php" class="btn btn-outline-secondary btn-sm me-3">
    ...
    <div class="col-lg-5">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="penggajian_read.php?id=<?= $id_gaji ?>">
                    ...
                    <a href="penggajian_read.php" class="btn btn-outline-secondary w-100 mt-2">Batal</a>
                </form>
            </div>
        </div>
    </div>

...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    ...
    <?php if ($role === 'admin'): ?>
        <a href="penggajian_add.php" class="btn btn-primary">
        ...
        <form method="GET" class="row row-cols-lg-auto g-2 align-items-center mb-3">
            ...
            <div class="col-12">
                ...
                <?php if ($cari !== '' || $bulan !== '' || $tahun !== ''): ?>
                    <a href="penggajian_read.php" class="btn btn-outline-danger">Reset</a>
                <?php endif; ?>
            </div>
        </form>
                        ...
                        <?php $no = 1; foreach ($daftar_gaji as $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="penggajian_edit.php?id=<?= $row['id_gaji'] ?>" class="btn btn-sm btn-warning text-white" title="Hitung Ulang / Detail">
                                        <i class="bi bi-arrow-repeat"></i>
                                    </a>
                                    <a href="penggajian_del.php?id=<?= $row['id_gaji'] ?>"

...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="pemotongan_gaji_add.php" class="btn btn-primary">
    ...
    <div class="card-body">
        <form method="GET" class="row row-cols-lg-auto g-2 align-items-center mb-3">
            ...
            <div class="col-12">
                ...
                <?php if ($cari !== '' || $bulan !== ''): ?>
                    <a href="pemotongan_gaji_read.php" class="btn btn-outline-danger">Reset</a>
                <?php endif; ?>
            </div>
        </form>
                        ...
                        <?php $no = 1; foreach ($daftar_potongan as $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="pemotongan_gaji_edit.php?id=<?= $row['id_potongan'] ?>" class="btn btn-sm btn-warning text-white" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a href="pemotongan_gaji_del.php?id=<?= $row['id_potongan'] ?>"

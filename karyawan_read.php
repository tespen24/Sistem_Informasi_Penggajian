...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="karyawan_add.php" class="btn btn-primary">
                        ...
                        <?php $no = 1; foreach ($daftar_karyawan as $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="karyawan_edit.php?id=<?= $row['id_karyawan'] ?>" class="btn btn-sm btn-warning text-white" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a href="karyawan_del.php?id=<?= $row['id_karyawan'] ?>"

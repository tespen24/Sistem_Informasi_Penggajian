...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="jabatan_add.php" class="btn btn-primary">
                        ...
                        <?php $no = 1; foreach ($daftar_jabatan as $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="jabatan_edit.php?id=<?= $row['id_jabatan'] ?>" class="btn btn-sm btn-warning text-white" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a href="jabatan_del.php?id=<?= $row['id_jabatan'] ?>"
